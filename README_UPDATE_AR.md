...
> **المؤلف**: محمد عصام - مهندس برمجيات 
...
كل تغييرات الحالة يتم تسجيلها في جدول واحد اسمه `AuditLog`. هذا الجدول هو (Single Source of Truth) لكل التغييرات اللي حصلت على أي طلب.
...
- ✅ لا توجد ثغرات في BUSINESS LOGIC
...
### Atomic transactions باستخدام `prisma.$transaction`
